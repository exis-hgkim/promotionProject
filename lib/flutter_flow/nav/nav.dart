...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const PromotionPageWidget() : const LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'PromotionPage',
          path: '/promotionPage',
          builder: (context, params) => const PromotionPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/promotionDetailPage',
          asyncParams: {
            'promotionDetail':
                getDoc(['promotions'], PromotionsRecord.fromSnapshot),
          },
          builder: (context, params) => PromotionDetailPageWidget(
            promotionDetail: params.getParam(
              'promotionDetail',
              ParamType.Document,
            ),
          ),
