                                          ...
                                          await showDialog<bool>(
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    ...
                                                    content: const Text(
                                                        '2024 함께 성장하는 보육인을 위한 C&I DAY 첫번째 이야기 데이터를 정말 삭제하시겠 습니까?'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return FlutterFlowDataTable<
                                          ...
                                          dataRowBuilder: (participantListItem,
                                                  participantListIndex,
                                                  selected,
                                                  onSelectChanged) =>
                                              DataRow(
                                            color: MaterialStateProperty.all(
                                              participantListIndex % 2 == 0
                                                  ? FlutterFlowTheme.of(context)
                                                      .secondaryBackground
                                                  : FlutterFlowTheme.of(context)
                                                      .primaryBackground,
                                          ...
                                          dataRowHeight: 48.0,
                                          columnSpacing: 10.0,
                                          headingRowColor: const Color(0x434B39EF),
                                          borderRadius:
