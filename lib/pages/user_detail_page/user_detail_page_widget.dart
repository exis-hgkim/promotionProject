...
class _UserDetailPageWidgetState extends State<UserDetailPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.fPList = await queryPromotionsRecordOnce();
      _model.testPromotionList =
          _model.fPList!.toList().cast<PromotionsRecord>();
      setState(() {});
    });
